package stanford.algorithms.part1.week2.tests;

import org.junit.Test;
import stanford.algorithms.part1.week2.QuickSort;
import stanford.algorithms.part1.week2.TestDataFactory;
...
public class TestQuickSort {
    ...
    @Test
    public void test1(){
        int [] original = TestDataFactory.loadData("testdata/stanford/algorithms/part1/week2/10.txt", 10);
    ...
    @Test
    public void test2(){
        int [] original = TestDataFactory.loadData("testdata/stanford/algorithms/part1/week2/100.txt", 100);
        int [] data = new int[original.length];
        System.arraycopy(original, 0, data, 0, original.length);
    ...
    @Test
    public void test3(){
        int [] original = TestDataFactory.loadData("testdata/stanford/algorithms/part1/week2/1000.txt", 1000);
        int [] data = new int[original.length];
        System.arraycopy(original, 0, data, 0, original.length);
