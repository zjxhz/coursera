...
import stanford.algorithms.part1.week4.DepthFirstSearch;
...
public class TestDepthFirstSearch {
    ...
    public void testMultipleOutgoingArcs(){
        Graph graph = GraphFactory.createGraph("testdata/stanford/algorithms/part1/week4/multipleOutgoingArcs.txt");
        assertEquals("1,2,3,4", dfs.search(graph));
    }

    @Test
    public void testDFS1(){
        Graph graph = GraphFactory.createGraph("testdata/stanford/algorithms/part1/week4/data1.txt");
    ...
    public void testScc2(){
        Graph graph = GraphFactory.createGraph("testdata/stanford/algorithms/part1/week4/data2.txt");
